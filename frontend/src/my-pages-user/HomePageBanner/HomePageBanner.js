...
const HomePageBanner = () => {
  ...
  useEffect(()=>{
    AdminService.getOptions('home_page_banner_image').then((data) => {
      const {
        banner1_image_url, 
        banner1_link,
        banner2_image_url,
  ...
  const handleUpdateBanner1 = () => {
    ...
    if ( banner1Image !== '' ) {
      ...
      AdminService.uploadImages('home_page_banner_desk', uploadData).then((data)=>{
    ...
    let _data = {
      banner1_image_url: '/home_page_banner_desk.jpg',
    ...
    const sendData = {
      option_name: 'home_page_banner_image',
      option_value: _data
    }
  ...
  const handleUpdateBanner2 = () => {
    ...
    if ( banner2Image !== '' ) {
      ...
      AdminService.uploadImages('home_page_banner_mobile', uploadData).then((data)=>{
        let reader = new FileReader();
    ...
    let _data = {
      banner2_image_url: '/home_page_banner_mobile.jpg',
      banner2_link: banner2Link
    }
  ...
  return (
    <Fragment>
      <PageTitle
          titleHeading="HomePage Banner Setup"
